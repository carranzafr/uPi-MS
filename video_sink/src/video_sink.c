...
#define AUTO_FULLSCREEN
    ...
    drt.src_rect.width      = env2_get(env2_VAR_SESSION_WIDTH);
    drt.src_rect.height     = env2_get(env2_VAR_SESSION_HEIGHT);
...
sDECODER_HW_BUFFER * video_sink_buf_get(
    void
    )
{
