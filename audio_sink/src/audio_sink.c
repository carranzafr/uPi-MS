    ...
    )
{
    ...
    printf("(audio_sink_init): Initialization completed...\n");
}


UINT8 * audio_sink_buffer_get(
    void
    )
{
...
void audio_sink_playback_speed_inc(
    )
{
...
void audio_sink_playback_speed_reset(
    )
{
    OMX_TIME_CONFIG_SCALETYPE  scale;
    OMX_ERRORTYPE error;
...
void audio_sink_playback_speed_dec(
    )
{
    OMX_TIME_CONFIG_SCALETYPE   scale;
    OMX_ERRORTYPE               error;
...
unsigned int audio_sink_ms_left_get(
    void
    )
{
